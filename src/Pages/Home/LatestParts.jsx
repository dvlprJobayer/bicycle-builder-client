...
const LatestParts = () => {
    ...
    return (
        <div className='container mx-auto'>
            <h2 className='text-5xl text-center text-primary mb-4'>Our Latest Collection</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center mb-8">
                {
